...
public class JuegoInfinityGame {
                ...
                do {
                    ...
                    switch (a) {
                        ...
                        case "s":
                            ...
                            reliquia objReliquia=new reliquia();
                            objReliquia.meditarExtra(jugadores[turno].getOpcionesMeditar());
    ...
    public static jugador avanzarTablero(jugador jugador, int largoTablero) {
        int num = jugador.lanzarDados();
        jugador.setPosicion(corrigePosicion(num, largoTablero, jugador.getPosicion()));
        reliquia objReliquia = new reliquia();
        objReliquia.restaurarVida(num, jugador.getVida());
        return jugador;
    }
